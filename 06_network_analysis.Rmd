...
q1 <- q1 + 
  scale_x_continuous(expand = expansion(add = c(1.1, 0.1))) +  # Adjust x-axis expansion
  scale_y_continuous(expand = expansion(add = c(0.1, 0.1)))    # Adjust y-axis expansion


ggsave("~/Desktop/pcoa.svg", q1, dpi = 300, width = 12,  height = 9, units = "in", device = "svg", bg="white") # , bg = "transparent"
