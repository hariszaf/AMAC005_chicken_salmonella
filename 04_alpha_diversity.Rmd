...
p1 <- ggplot(sscores_length, aes(x = length_ratio, y = Complementarity)) +
  ...
  annotate("text",
           ...
           hjust = 1.1, vjust = 1.2,
           size = 4, color="black", family="Inter-Medium"
  ) +
  labs(
...
q1 <- make_hist(samples_length_scores, "mean_competition",
                "Mean competition per sample")

q2 <- make_hist(samples_length_scores, "mean_cooperation",
...
ggsave("coop_S_based_on_pos_assoc.png", r1_S, dpi=300, width = 12, height=8)
